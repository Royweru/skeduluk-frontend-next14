  ...
  const handleTranscription = async (audioBlob: Blob) => {
    ...
    try {
      ...
      const transcribeRes = await fetch('/api/posts/transcribe', {
        ...
        body: JSON.stringify({ audio_url: uploadData.audio_file_url })
      });
    ...
    <div className="relative">
      <Button
        ...
        className={cn(
          ...
          !isRecording && !isTranscribing && "border-purple-200 hover:border-purple-400 hover:bg-purple-50"
        )}
      >
        ...
        <div className="relative z-10">
          {isTranscribing ? (
            <>
              ...
              <span className="text-sm font-medium text-blue-900">Transcribing...</span>
              <span className="text-xs text-blue-700">AI is processing your audio</span>
            </>
          ) : isRecording ? (
            <>
              <Square className="h-8 w-8 text-red-600" />
              <div className="flex flex-col items-center">
                <span className="text-sm font-semibold text-red-900">Stop Recording</span>
            ...
            <>
              ...
              <span className="text-sm font-semibold text-purple-900">Voice to Text</span>
      ...
      <div className="mt-2 flex items-center gap-2 text-xs text-gray-600">
        ...
        <span>Click to record • AI will transcribe and fix grammar automatically</span>
      </div>
    </div>
  );
}