...
export const TemplateDetailModal: React.FC<TemplateDetailModalProps> = ({
  ...
  const { data: analytics, isLoading: analyticsLoading } = useTemplateAnalytics(
    template?.id || 0
  );
  ...
  const renderPlatformVariations = () => {
    if (!template.platform_variations || Object.keys(template.platform_variations).length === 0) {
      return (
        <div className="text-center py-8 text-gray-500">
          <Info className="h-8 w-8 mx-auto mb-2 opacity-50" />
    ...
    return (
      <div className="space-y-4">
        {Object.entries(template.platform_variations).map(([platform, content]) => (
          <div
            key={platform}
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-blue-700 font-medium">Total Uses</span>
            </div>
          ...
          <div className="p-4 rounded-lg bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-purple-700 font-medium">Avg Engagement</span>
            </div>
          ...
          <div className="p-4 rounded-lg bg-gradient-to-br from-orange-50 to-orange-100 border-2 border-orange-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-orange-700 font-medium">Recent Posts</span>
            </div>
        ...
        {analytics.engagement_trend.length > 0 && (
          <div className="p-4 rounded-lg border-2 border-gray-200 bg-white">
            <h4 className="font-semibold mb-4">Engagement Trend (Last 30 Days)</h4>
