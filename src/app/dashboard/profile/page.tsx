...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50">
      {/* Header with Avatar */}
      <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-indigo-800 text-white relative overflow-hidden">
        {/* Decorative elements */}
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 relative z-10">
          ...
          >
            ...
            <div className="relative">
              <div className="w-28 h-28 rounded-3xl bg-gradient-to-br from-amber-400 to-yellow-500 flex items-center justify-center text-4xl font-bold text-purple-900 shadow-2xl">
                {user?.username?.substring(0, 2).toUpperCase() || "U"}
              </div>
              <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-xl flex items-center justify-center border-4 border-purple-700">
            ...
            >
              ...
              <div className="p-4 space-y-2">
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 rounded-xl border border-amber-200 bg-amber-50 text-amber-700 hover:bg-amber-100 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full flex items-center gap-3 p-4 rounded-xl border border-red-200 bg-red-50 text-red-700 hover:bg-red-100 transition-colors"
                >
      ...
      {show && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6 bg-white rounded-2xl shadow-2xl z-50"
          >
